...
class TestLongProfit(unittest.TestCase):
    ...
    def setUpClass(cls):
        with freeze_time("2022-08-16 13:30:00") as frozen_datetime:
            ...
            cls.bot = AMDBot(cls.ib, "TWTR")
    
            cls.bot.setup()
            cls.tracker = TrackerWrapper(cls.bot.executionTracker)
            
            file_name = "../Data/TWTR_2022-08-16.pkl"
    ...
    def test_short_order_sent(self):
        self.assertFalse(self.bot.executionTracker.isShortOrderSent(), "Short Order Sent")
    ...
    def test_stock_closed(self):
        self.assertIn("TWTR", self.ib.stocksClosed, "TWTR is set as a stock to close")

    def test_stock_to_close(self):
        self.assertNotIn("TWTR", self.ib._stocksToClose, "TWTR is set as a stock to close")
...
@freeze_time("2022-08-16 9:16:00", tz_offset=-8)
