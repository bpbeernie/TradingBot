...
class TestHalfProfit(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        with freeze_time("2022-08-04 13:30:00") as frozen_datetime:
                
            requestID = 1
            cls.ib = IBWrapper()
            
            cls.bot = AMDBot(cls.ib, "BABA")
    
            cls.bot.setup()
            cls.tracker = TrackerWrapper(cls.bot.executionTracker)
            
            file_name = "../Data/BABA_2022-08-04.pkl"
    ...
    def test_stock_closed(self):
        self.assertFalse(len(self.ib.stocksClosed)==0, "No stocks were closed")
...
@freeze_time("2022-08-11 7:19:35")
